...
csv_text = File.read(Rails.root.join('db' , 'seed_files' , 'us', 'miso_zip_053122b.csv' ))
...
csv.each do |row|
	...
	city.save!
	zipcode =  BxBlockStatesCities::Zipcode.find_or_initialize_by(code: zip, grid_type: 'MISO', city_id: city.id)
...
# 	state.save
# end
# BxBlockStatesCities::State.import import_states, recursive: true, validate: true, validate_uniqueness: true
# puts "invalid states are #{BxBlockStatesCities::State.all.reject{ |a| a.valid? }.count}............"
# puts "invalid states are #{BxBlockStatesCities::City.all.reject{ |a| a.valid? }.count}..............."
# puts "invalid states are #{BxBlockStatesCities::Zipcode.all.reject{ |a| a.valid? }.count}............"